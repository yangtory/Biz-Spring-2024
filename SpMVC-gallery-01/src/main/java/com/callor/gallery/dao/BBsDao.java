 ...
 * GenericDao 에 선언된 5가지 CRUD method 는 그대로 상속 받는다
 * 이 때 return type 과 PK 매개변수의 type 을 필요한 요소로 대체한다
 * 
 * 대체할 때 Generic Type(<>) 에 명시해 준다
 * 그 외 필요한 method 가 있으면 별도로 선언하여 사용할 수 있다
 * 
 * 결국 BBsDao 에는 총 8가지 method 가 선언되는 것과 같다
 */
