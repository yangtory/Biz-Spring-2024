...
<body>
	...
	<form class="image input" method="post" enctype="multipart/form-data" >
		...
		<div><input type="password" placeholder="비밀번호" name="g_password"></div>
		<div><input name="files" id="files" type="file" multiple="multiple" accept="image/*"></div>
		<div class="represent"><img class='represent' src="${rootPath}/images/tree.png"/></div>
