...
<div class="iolist detail">
	...
	<div><strong>${IO.io_inout} 단가</strong><span>${IO.io_iprice ne 0 ? IO.io_iprice : IO.io_oprice}</span></div>
	<div><strong>${IO.io_inout} 합계</strong><span>${IO.io_itotal ne 0 ? IO.io_itotal : IO.io_ototal }</span></div>
	<div>
		<strong></strong>
		<span>
